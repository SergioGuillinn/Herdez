...
import SurveyRenderer from '../SurveyTypes/SurveyRenderer.jsx'; // Ensure correct path to SurveyRenderer
...
const FetchSurvey = () => {
  ...
  useEffect(() => {
    const fetchSurveyData = async () => {
      try {
        const response = await fetch('http://localhost:3002/api/nutrisa'); // Fetch dynamic survey JSON from backend
